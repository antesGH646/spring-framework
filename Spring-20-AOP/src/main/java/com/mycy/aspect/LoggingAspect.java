...
public class LoggingAspect {
    ...
    @Pointcut("execution(* com.mycy.controller.CourseController.*(..))")
    ...
    @Before("execution(* com.mycy.controller.CourseController.*(..))")
    public void beforeAdvice(){
        logger.info("Logger info ------");
    }

    @Pointcut("execution(* com.mycy.repository.CourseRepository.findById(*))")
    ...
    @Pointcut("within(com.mycy.controller..*)")
    ...
    @Pointcut("@annotation(com.mycy.annotation.Loggable)")
