...
import com.mycy.service.StudentService;
...
class StudentControllerTest {
    ...
    @MockBean//mocks and injects a bean, meaning mocks the existing bean injection
    ...
    void jsonAssert() throws JSONException {
        ...
        JSONAssert.assertEquals(expected,actual, false);//if the both are equal, True/False pass
        JSONAssert.assertEquals(expected,actual, false);//if the both are not equal, only False pass
    }
